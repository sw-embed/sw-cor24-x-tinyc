use cc24_ast::Function;
use cc24_codegen_state::CodegenState;
use cc24_emit_core::{emit, new_label};
use cc24_struct_isr::{emit_isr_epilogue, emit_isr_prologue};
use cc24_struct_locals::collect_locals_block;
use cc24_struct_prologue::{emit_epilogue, emit_prologue};
