...
DEMO_C="$SCRIPT_DIR/demo58.c"
DEMO_S="$SCRIPT_DIR/demo58.s"
...
if [ "$R0" = "58" ]; then echo "  [PASS] r0 = 58"; else echo "  [FAIL] r0 = $R0"; PASS=false; fi
if echo "$UART" | grep -q "D58OK"; then echo "  [PASS] UART: D58OK"; else echo "  [FAIL] UART: '$UART'"; PASS=false; fi
echo ""
if [ "$PASS" = true ]; then echo "Demo 58 PASSED"; else echo "Demo 58 FAILED"; exit 1; fi
