...
if echo "$UART" | grep -q "D42OK"; then echo "  [PASS] UART: D42OK"; else echo "  [FAIL] UART: '$UART'"; PASS=false; fi
echo ""
if [ "$PASS" = true ]; then echo "Demo 42 PASSED"; else echo "Demo 42 FAILED"; exit 1; fi
